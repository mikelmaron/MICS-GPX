...
class RenderThread:
    ...
    def render_tile(self, tile_uri, x, y, z):
        ...
        #grid = mapnik.render_grid(self.m,1,key='FID_1',resolution=4,fields=['FID_1','INSTANCE','SUBMISSION','N503003_WH','N552001_IS','N557001_PL','N560001_PL','N568002_PL','N563001_WH','N566001_WH','N540002_PL','N528003_PL','N574001_DO'])
...
if __name__ == "__main__":
    ...
    # World
    bbox = (30.708,-27.414,32.179,-25.652)
    render_tiles(bbox, mapfile, tile_dir, 9, 9, "World",tms_scheme=False)
